...
<main class="page-content">
    ...
    <div class=" p-2 d-flex justify-content-center">
        ...
        <div class="card col-md-8 col-12">
            <div class="p-4">
                <form action="">
                    <p> <b> Billing Info </b> <br><span class="sub-text"> Please enter your billing info </span></p>
                    <div class="row">
                        <div class="col-sm-6 col-12 p-2">
                            <label class="labels"> First Name </label> <br>
                            <input type="text" placeholder="First name" class="form-control" readonly>
                        </div>

                        <div class="col-sm-6 col-12 p-2">
                            <label class="labels"> Last Name </label> <br>
                            <input type="text" placeholder="Last name" class="form-control" readonly>
                        </div>

                        <div class="col-sm-6 col-12 p-2">
                            <label class="labels"> Email Address </label> <br>
                            <input type="text" placeholder="Email Address" class="form-control" readonly>
                        </div>
                        ...
                        <div class="col-sm-6 col-12 p-2">
                            ...
                            <input type="text" placeholder="Address" class="form-control" readonly>
                        </div>

                        <div class="col-sm-6 col-6 p-2">
                            <label class="labels"> Town / City </label> <br>
                            <input type="text" placeholder="Town/ City" class="form-control" readonly>
                        </div>

                        <div class="col-sm-6 col-6 p-2">
                            <label class="labels"> State/ Country </label> <br>
                        ...
                        <div class="col-sm-6 col-12 p-2">
                            <label class="labels"> ZIP / Postal Code </label> <br>
                            <input type="text" placeholder="ZIP/ Postal Code" class="form-control" readonly>
                        </div>

                        <div class="col-12">
                            To update delivary address contact to <a href="contact-us.php"> admin </a>
                        </div>

                        <div class="col-12 mt-2">
                            <div class="mt-3">
                                <a class="btn btn-primary border-0" href="check-out.php">
                                    <i class="fas fa-shopping-basket"></i>

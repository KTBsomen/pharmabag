                        ...
                        <div class="mt-4">
                            <button type="submit" class="btn btn-primary border-0" style="width: 100%">Submit</button>
                                ...
                                <div class="col-12 mt-4">
                                    <h3>All Tickets</h3>
                                    <div>
                                        <div class="col-12 alert-info mt-4">
                                            <div>
                                                <p><span>Ticket No: </span> <span> #00145</span></p>
                                                <p>Date: <span> 26-05-2023 </span> </p>
                                                <p>Status : <span class="badge bg-warning"> Processing</span></p>
                                                <hr>
                                                <div class="orders">
                                                    <ul>
                                                        <li><span>Reason : </span> <span> Reason 1</span></li>
                                                        <li><span>Subject : </span><span> Payment Error </span></li>
                                                        <li><span>Message : </span><span> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Porro, repudiandae! </span></li>
                                                    </ul>
                                                </div>

                                                <div class="mt-3 orders">
                                                    <a href="ticket-details.php" class="mx-4">
                                        ...
                                        <div class="col-12 alert-info mt-4">
                                            <div>
                                                <p><span>Ticket No: </span> <span> #00145</span></p>
                                                <p>Date: <span> 26-05-2023 </span> </p>
                                                <p>Status : <span class="badge bg-success"> Closed</span></p>
                                                <hr>
                                                <div class="orders">
                                                    <ul>
                                                        <li><span>Reason : </span> <span> Reason 1</span></li>

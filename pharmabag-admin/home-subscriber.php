            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Subscribers Settings</li>
                    </ol>
                </nav>
            </div>
            <div class="ms-auto">
            ...
            <div class="card-body">
                <div class="table-responsive mt-3">
                    <table class="table align-middle">
                        ...
                        <tbody>
                            <tr>
                                <td>Get 20% Discount For Subscriber</td>
                                <td>Lorem ipsum dolor consectetur adipisicing accusantium</td>                                
                                <td> Subscribe </td>
                                <td>

    ...
    <main class="page-content">
        ...
        <div class="card">
            <div class="card-header py-3">
                <h6 class="mb-0">Add Product Sub Category</h6>
            </div>
            <div class="card-body">
                <div class="row">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table align-middle">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-3 fs-6">
                                                        <a href="" class="text-warning" data-bs-toggle="modal" data-bs-target="#edit-cat"><i class="bi bi-pencil-fill"></i></a>

                                                        <a class="text-danger" data-bs-toggle="modal" data-bs-target="#delete-sub-category"><i class="bi bi-trash-fill"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form class="row g-3">
                                                            <div class="col-12">
                                                                <label class="form-label">Name</label>
                                                                <input type="text" class="form-control" placeholder="Category name" value="Ethical">
                                                            </div>
                                                            <div class="col-12">
                                        ...
                                        <div class="modal fade" id="delete-sub-category">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>

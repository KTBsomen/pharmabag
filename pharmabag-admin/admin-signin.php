                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="card-body p-4 p-sm-5">
                                <h5 class="card-title">Super Admin Sign In</h5>

                                <form class="form-body">

                                    <div class="row g-3">
                                        <div class="col-12">
                                            <label for="inputEmailAddress" class="form-label">Username or Email Address</label>
                                            <div class="ms-auto position-relative">
                                                <div class="position-absolute top-50 translate-middle-y search-icon px-3"><i class="bi bi-envelope-fill"></i></div>
                                                <input type="text" class="form-control radius-30 ps-5" id="inputEmailAddress" placeholder="Email Address">
                                            </div>
                                        </div>
                                        <div class="col-12">
                                        ...
                                        <div class="col-6 text-end"> <a href="admin-forgot-password.php">Forgot Password ?</a>
                                        </div>
                                        <div class="col-12">
                                            <div class="d-grid">
                                        ...
                                        <div class="col-12">
                                            <p class="mb-0">Don't have an account yet? <a href="admin-signup.php">Sign up here</a></p>
                                        </div>
                                    </div>
                                </form>
                            </div>

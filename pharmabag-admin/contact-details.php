...
-->
    ...
    <main class="page-content">
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <h5 class="mb-0"> Contact Details
                        <a href="" class="text-warning px-3" data-bs-toggle="modal" data-bs-target="#edit-contact"><i class="bi bi-pencil-fill"></i></a>
                    </h5>
                ...
                <div class="table-responsive mt-3">
                    <table class="table align-middle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>Email id</td>
                                <td>info@pharmabag.in</td>
                            </tr>
                            <tr>
                                <td>Email id</td>
                                <td>contact@pharmabag.in</td>
                            </tr>
                            <tr>
                                <td>Address 1</td>
                                <td>13A/40, Ariff Rd, Daspara, Ultadanga, Kolkata, West Bengal 700067</td>
                            </tr>
                            <tr>
                                <td>Facebook</td>
                                <td>Link 1</td>

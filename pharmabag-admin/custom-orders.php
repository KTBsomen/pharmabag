                    ...
                    <table class="table ">
                        ...
                        <tbody class="align-items-center">
                            <tr>
                                ...
                                <td> 20-11-2022 </td>
                                <td> <a href="#" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#upload-invoice">View</a> </td>

                                <td> <a class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#replyorder">View</a> </td>
                                   ...
                                   <p>Seller Reply</p>
                                    <form class="row">
                                        ...
                                        <div class="col-12 col-sm-6">
                                            ...
                                            <input type="text" class="form-control" value="11-11-2022" readonly>
                                        </div>
                                        ...
                                        <div class="col-12 col-sm-6">
                                            <label>Date Range</label>
                                            <input type="text" class="form-control" value="20-11-2022" readonly>
                                        </div>
                                    </form>
                                    <hr>
                                    <p>Buyer Reply</p>

...
-->
    ...
    <main class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Refer</div>
            <div class="ps-3">
        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex align-items-center">
                    ...
                    <button data-bs-toggle="modal" data-bs-target="#add-ref-code" id="theme-button" class="mx-3">
                        Add</button>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="table-actions d-flex align-items-center gap-3 fs-6">
                                        ...
                                        <a href="referral-details.php" class="text-primary" title="View"><i class="bi bi-eye-fill"></i></a>

                                        <a href="" class="text-warning dropdown-toggle" data-bs-toggle="modal" data-bs-target="#edit-ref-code" title="Edit"><i class="bi bi-pencil-fill"></i></a>
    ...
    <!--                   add refferal code modal-->

    <div class="modal fade" id="add-ref-code">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
    ...
    <div class="modal fade" id="edit-ref-code">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>

...
-->
    ...
    <main class="page-content">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Approved Seller</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <h5 class="mb-0">Approved List</h5>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="table-actions d-flex align-items-center gap-3 fs-6">
                                        <a href="user-profile.php" class="text-primary" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Views"><i class="bi bi-eye-fill"></i></a>

                                        <a href="" class="text-warning dropdown-toggle" data-bs-toggle="dropdown" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Edit"><i class="bi bi-pencil-fill"></i></a>

                                        <!--dropdown-->
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                            <li><a class="dropdown-item" href="#">Pending Review</a></li>
                                            <li><a class="dropdown-item" href="#">Approved</a></li>
                                            <li><a class="dropdown-item" data-bs-target="#reject" data-bs-toggle="modal">Reject</a></li>
                                            <li><a class="dropdown-item" data-bs-target="#suspend" data-bs-toggle="modal">Suspend Temporarily</a></li>
                                            <li><a class="dropdown-item" data-bs-target="#suspend-per" data-bs-toggle="modal">Suspend Permanently</a></li>
                                            <li><a class="dropdown-item" data-bs-target="#com-rate" data-bs-toggle="modal">Set Commission Rate (%) </a></li>
                                        </ul>

                                        <!-- suspended temporarily modal -->
                                        <div class="modal fade" id="suspend-per">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <p>Are you sure you want to suspend this user permanently.</p>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-primary">Suspend
                                                            Now</button>
                                                    </div>
                                                </div>
                                            </div>
    ...
    <!--                                    delete product modal-->
    <div class="modal fade" id="com-rate">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                ...
                <div class="modal-body">
                    <form action="">
                        ...
                        <label class="form-label"> Commission Rate </label> <br>

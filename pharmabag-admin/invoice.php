        ...
        <div class="card-header py-3">
            <div class="row g-3 align-items-center">
                ...
                <div class="col-12 col-lg-3 col-6 col-md-3">
                    <button type="button" class="btn btn-primary" href="javascript:generatePDF()"><i class="fa fa-download"></i> Invoice </button>
                </div>
            </div>
        </div>
        ...
        <div class="container p-5 card">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <img class="mb-3" width="180" src="assets/images/brand-logo-2.png" alt="logo">
                    <h6 class="mb-2 text-capitalize text-success">
                        Pharmabag a unit of Jaiswal Pharma
                    </h6>
                    <hr>
                </div>
                <div class="col-lg-12">
                    <div class="d-flex justify-content-between header-info">
                        ...
                        <div class="mb-4">
                            <h6 class="text-capitalize mb-3">Company Details</h6>
                            <ul class="p-0">
                                <li class="d-flex align-items-start justify-content-start mb-1">
                                    <b>GST: </b><span> GSTINXXXXXXXXX</span>
                                </li>
                                <li class="d-flex align-items-start justify-content-start mb-1">
                                    <b>PAN: </b><span> PAN********</span>
                                </li>
                                <li class="d-flex align-items-start justify-content-start mb-1">
                                    <b>D.L. No.: </b><span> DL*********</span>
                                </li>
                                <li class="d-flex align-items-start justify-content-start mb-1">
                                    <b>D.L. No.: </b><span> DL*********</span>
                                </li>
                        ...
                        <div class="mb-4">
                            ...
                            <ul class="p-0">
                                <li class="d-flex align-items-start justify-content-start mb-1">
                                    ...
                                    <p class="mb-0" style="width: 200px;">#00456</p>
                                </li>
                                <li class="d-flex align-items-start justify-content-start mb-1">
                                ...
                                <li class="d-flex align-items-start justify-content-start mb-1">
                                    <p class="text-capitalize mb-0" style="width: 160px;">order time</p>
                                    <p class="mb-0" style="width: 200px;">12:25 am</p>
                                </li>
                                <li class="d-flex align-items-start justify-content-start mb-1">
                                    <p class="text-capitalize mb-0" style="width: 160px;">contact number</p>
                                    <p class="mb-0" style="width: 200px;">+91 1234567890</p>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="col-lg-12">
                    <div class="mb-4">
                        ...
                        <span> House 17/A, West Jalkuri </span>,
                        Street: <span> Street Address</span>,
                        City: <span> Kolkata </span>,
                        Pin: <span> 700 001 </span>
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="table-scroll table-responsive">
                        <table class="table table-bordered text-center tables">
                            ...
                            <tbody>
                                <tr>
                                    <th scope="row">1</th>
                                    <td class="text-capitalize">PRACTIN TABLET</td>
                                    <td>₹ 20</td>
                                    <td>10%</td>
                                    <td>03</td>
                                    <td>₹ 763</td>
                    ...
                    <div>
                        <div>
                            <h6 class="text-capitalize mb-3">Jaiswal Pharma</h6>
                            <ul class="p-0">
                                <li class="d-flex align-items-start justify-content-start mb-1">
                                    <b>GST: </b><span> GSTINXXXXXXXXX</span>
                                </li>
                                ...
                                <li class="d-flex align-items-start justify-content-start mb-1">
                                    <b>D.L. No. 20B: </b><span> DL*********</span>
                                </li>
                                <li class="d-flex align-items-start justify-content-start mb-1">
                                    <b>D.L. No. 21B: </b><span> DL*********</span>
                                </li>

                                <li style="list-style-type:none">
                                    <span><b>Company Address</b></span>
                                    <span class="mb-0" style="width: 200px;">House 17/A, West Jalkuri</span>,
                                    <span class="mb-0" style="width: 200px;">Street: Street Address</span>,
                                    <span class="mb-0" style="width: 200px;">City: <span> Kolkata </span></span>,
                                    <span class="mb-0" style="width: 200px;">Pin: <span> 700 001 </span></span>
                                </li>
                            </ul>
                        </div>
                    </div>

                        ...
                        <div class="col-lg-12 col-12">
                            <div class="card-body p-4 p-sm-5">
                                ...
                                <form class="form-body">
                                    <div class="row g-3">
                                        <div class="col-12">
                                            <label for="inputEmailid" class="form-label">Enter your registared Email id</label>
                                        ...
                                        <div class="col-12">
                                            <div class="d-grid gap-3">
                                                ...
                                                <a href="admin-signin.php" class="btn btn-lg btn-light radius-30">Back to Login</a>
                                            </div>
                                        </div>
                                    </div>
                                </form>

...
-->
    ...
    <main class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Referal Code </div>
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        <li class="breadcrumb-item"><a><i class="bx bx-home-alt"></i></a>
                        </li>
                        <li class="breadcrumb-item active" aria-current="page">Referal Code Details</li>
                    </ol>
                </nav>
            </div>
            <div class="ms-auto">
        ...
        <div class="card">
            <div class="modal-body">
                <h6>Name: <span> Thomas Hardy </span></h6>
                <p>Code: <span> #1553 </span> </p>
                <h5>Total Sale: <span> ₹ 50000.00 </span></h5>
            </div>
        </div>

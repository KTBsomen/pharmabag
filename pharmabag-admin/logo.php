                ...
                <div class="mt-3 row">
                        ...
                        <div class="p-2 shadow">
                            <div class="card-header">
                                <div class="d-flex justify-content-between">
                                    <span class="mb-3">Home Page Header Logo</span>
                                    <a href="" class="text-warning" data-bs-toggle="modal" data-bs-target="#edit-contact"><i class="bi bi-pencil-fill"></i></a>
                                </div>
                            </div>
                            <div class="card-header justify-content-center align-items-center">
                                <img src="assets/images/brand-logo-2.png" alt="" height="60px">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-4 mb-4">
                        <div class="p-2 shadow">
                            <div class="card-header">
                                <div class="d-flex justify-content-between">
                                    <span class="mb-3">Home Page Footer Logo</span>
                                    <a href="" class="text-warning" data-bs-toggle="modal" data-bs-target="#edit-contact"><i class="bi bi-pencil-fill"></i></a>
                                </div>
                            </div>
                            <div class="card-header justify-content-center align-items-center">
                    ...
                    <div class="col-12 col-sm-6 col-md-4 mb-4">
                        <div class="p-2 shadow">
                            <div class="card-header">
                                <div class="d-flex justify-content-between">
                                    <span class="mb-3">Fav Icon</span>
                                    <a href="" class="text-warning" data-bs-toggle="modal" data-bs-target="#edit-contact"><i class="bi bi-pencil-fill"></i></a>
                                </div>
                            </div>
                            <div class="card-header justify-content-center align-items-center">
                                <img src="assets/images/logo-icon.png" alt="" height="60px">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-4 mb-4">
                        <div class="p-2 shadow">
                            <div class="card-header">
                                <div class="d-flex justify-content-between">
                                    <span class="mb-3">Seller Admin Logo</span>
                                    <a href="" class="text-warning" data-bs-toggle="modal" data-bs-target="#edit-contact"><i class="bi bi-pencil-fill"></i></a>
                                </div>
                            </div>
                            <div class="card-header justify-content-center align-items-center">
                    ...
                    <div class="col-12 col-sm-6 col-md-4 mb-4">
                        <div class="p-2 shadow">
                            <div class="card-header">
                                <div class="d-flex justify-content-between">
                                    <span class="mb-3">Super Admin Logo</span>
                                    <a href="" class="text-warning" data-bs-toggle="modal" data-bs-target="#edit-contact"><i class="bi bi-pencil-fill"></i></a>
                                </div>
                            </div>
                            <div class="card-header justify-content-center align-items-center">
                    ...
                    <div class="col-12 col-sm-6 col-md-4 mb-4">
                        <div class="p-2 shadow">
                            <div class="card-header">
                                <div class="d-flex justify-content-between">
                                    <span class="mb-3">Invoice Logo</span>
                                    <a href="" class="text-warning" data-bs-toggle="modal" data-bs-target="#edit-contact"><i class="bi bi-pencil-fill"></i></a>
                                </div>
                            </div>
                            <div class="card-header justify-content-center align-items-center">
                    ...
                    <div class="col-12 col-sm-6 col-md-4 mb-4">
                        <div class="p-2 shadow">
                            <div class="card-header">
                                <div class="d-flex justify-content-between">
                                    <span class="mb-3">Admin Author Page Logo</span>
                                    <a href="" class="text-warning" data-bs-toggle="modal" data-bs-target="#edit-contact"><i class="bi bi-pencil-fill"></i></a>
                                </div>
                            </div>
                            <div class="card-header justify-content-center align-items-center">

                        ...
                        <table class="table table-borderless">
                            ...
                            <tbody class="align-items-center">
                                <tr>
                                    ...
                                    <td> #123345 </td>
                                    <td> ₹123364 </td>
                                    <td> <span class="pending"> Order Pending </span> </td>
                                    <td> <a href="assets/images/uploads/u1LA9uZn.pdf" target="_blank" class="btn btn-primary btn-sm"> View </a> </td>
                                    <td>
                                        <div class="table-actions d-flex align-items-center gap-3 fs-6">
                                            ...
                                            <a class="text-warning dropdown-toggle" data-bs-toggle="dropdown" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Edit"><i class="bi bi-pencil-fill"></i></a>

                                            <!--dropdown-->
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item" href="#">Order Pending</a></li>
                                                <li><a class="dropdown-item" href="#">Order Confirmed</a></li>
                                                <li><a class="dropdown-item" href="#">Order in Transit</a></li>

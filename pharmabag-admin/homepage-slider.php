                ...
                <div class="table-responsive mt-3">
                    <table class="table align-middle">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <img src="assets/images/products/01.jpg" alt="" width="60" height="60">
                                </td>
                                <td>we are delivered Medicine.</td>
                                <td>Lorem ipsum dolor consectetur adipisicing elit modi consequatur eaque expedita porro necessitatibus eveniet voluptatum quis pariatur Laboriosam molestiae architecto excepturi</td>
                                <td>Shop now</td>
                                <td>

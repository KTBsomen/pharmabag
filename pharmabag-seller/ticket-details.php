        ...
        <div class="container mt-2" id="ticket">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-body">
                        <div class="">
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptas ab dolorum odit minima
                                laborum tenetur!</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="card mt-3">
                <div class="card-header">
                    ...
                    <div class="card-body">
                        <div class="">
                            <p> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusantium assumenda dolor
                                voluptates voluptate nihil expedita, ad hic, quod harum nemo. </p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="input-group" id="reply">
                ...
                <button class="input-group-text" style="background: #8bc73a;" id="closechat" onclick="closed()">Close
                    Chat</button>
            </div>

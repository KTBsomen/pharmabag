        ...
        <div class="container p-4">
            ...
            <div class="clearfix">
                <ul class="nav nav-pills float-start" role="tablist" id="nav-pill-background">
                    <li class="nav-item"> <a class="nav-link active" data-bs-toggle="pill" href="#pending"> Pending </a>
                    </li>
            ...
            <div class="tab-content mt-2">
                <div class="tab-pane active" id="pending">
                    ...
                    <div class="table-responsive p-3">
                        <table class="table ">
                            ...
                            <tbody class="align-items-center">
                                <tr>
                                    ...
                                    <td> <a href="#" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#upload-invoice">Upload</a> </td>
                                    ...
                                    <td> <a class="btn btn-primary btn-sm dropdown-toggle" data-bs-toggle="dropdown">Reply</a>
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a href="" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#replyorder">Set Milestone</a></li>
                        ...
                        <div class="modal fade" id="replyorder">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5>Divide Order</h5>
                                    ...
                                    <div class="modal-body">
                                        <form class="row">
                                            ...
                                            <input type="submit" name="submit" value="submit" class="next mt-3  btn btn-primary">

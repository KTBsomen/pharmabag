        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="container p-4">
                    ...
                    <div class="shadow-sm border p-3 notification-msg-box">
                        <div class="row">
                            <div class="col-xxl-1 col-md-1 col-6">
                                <p> <i class="fa fa-shopping-bag icon"> </i></p>
                            </div>
                            <div class="col-xxl-11 col-md-11 col-6 notification-msg">
                                <p> <b> Alexa placed an order. </b> </p> <br>
                    ...
                    <div class="shadow-sm border p-3 notification-msg-box">
                        <div class="row">
                            <div class="col-xxl-1 col-md-1 col-6">
                                <p> <i class="fa fa-ticket icon"> </i></p>
                            </div>
                            <div class="col-xxl-11 col-md-11 col-6 notification-msg">
                                <p> <b> John raised a ticket. </b> </p> <br>
                                <p> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sunt, voluptatum.</p>
                                <p> 12 mins ago</p>
                            </div>
                        </div>
                    ...
                    <div class="shadow-sm border p-3 notification-msg-box">
                        <div class="row">
                            <div class="col-xxl-1 col-md-1 col-6">
                                <p> <i class="fa fa-circle-check icon"> </i></p>
                            </div>
                            <div class="col-xxl-11 col-md-11 col-6 notification-msg">
                                <p> <b> 25 Product request pending. </b> </p> <br>
                                <p> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sunt, voluptatum.</p>
                                <p> 10 mins ago</p>
                            </div>
                        </div>
                    ...
                    <div class="shadow-sm border p-3 notification-msg-box">
                        <div class="row">
                            <div class="col-xxl-1 col-md-1 col-6">
                                <p> <i class="fa fa-user icon"> </i></p>
                            </div>
                            <div class="col-xxl-11 col-md-11 col-6 notification-msg">
                                <p> <b> 5 Seller verification pending. </b> </p> <br>
                                <p> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sunt, voluptatum.</p>
                                <p> 10 mins ago</p>
                            </div>
                        </div>

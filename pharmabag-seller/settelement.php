            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Settelement</li>
                    </ol>
                </nav>
            </div>
            <div class="ms-auto">
        ...
        <div class="container p-4">
            ...
            <div class="clearfix">
                <ul class="nav nav-pills float-start" role="tablist" id="nav-pill-background">
                    <li class="nav-item"> <a class="nav-link active" data-bs-toggle="pill" href="#all"> All </a> </li>
                    <li class="nav-item"> <a class="nav-link" data-bs-toggle="pill" href="#remittence"> Remittence </a> </li>
                </ul>

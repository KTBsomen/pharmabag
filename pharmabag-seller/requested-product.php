                    ...
                    <table class="table align-middle table-striped">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><span class="badge rounded-pill alert-success">pending</span></td>
                                <td>
                                    <div class="d-flex align-items-center gap-3 fs-6">

                                        <!-- <a href="javascript:;" class="text-primary"><i class="bi bi-eye-fill"></i></a> -->

                                        <a href="#" class="text-warning dropdown-toggle" data-bs-toggle="dropdown"><i class="bi bi-pencil-fill"></i></a>
                                        <!--                                        dropdown-item-->
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                            <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#upload"> &#43; Add Inventory </a></li>
                                            <li><a class="dropdown-item" href="#"> &#45; Reject </a></li>

                                            <li><a class="dropdown-item" href="https://project.pharmabag.in/contact-us.php"> &#45; Contact Admin </a></li>

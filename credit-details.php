                                ...
                                <div class="col-12 alert-info">
                                    <div>
                                        ...
                                        <div class="d-flex orders">
                                            <ul>
                                                <li><span>Payment Date: </span> <span> 26-5-2023</span></li>
                                                <li><span>Payment Method: </span> <span> Paypal</span></li>
                                            </ul>
                                            <ul>
                                                <li><span>Amount: </span> <span> ₹ 200.00</span></li>
                                                <li><span>Payment Status: </span><span class="badge bg-success"> Payment Success </span></li>
                                            </ul>
                                        </div>

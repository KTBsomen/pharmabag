    ...
    <div class="row">
        ...
        <div class="col-12 col-md-9 order-first order-md-last">
            <div class="container">
                        ...
                        <div class="mb-3 col-12">
                            <div class="row">
                                <div class="col-12 alert-info">
                                    <div>
                                        <h5> Order Date: <span> 26-5-2023 </span> </h5>
                                        <hr>
                                        <div class="d-flex orders">
                                            <ul>
                                                <li><span>Order Id: </span> <span> #00145</span></li>
                                        ...
                                        <div class="mt-3 orders">
                                            <a href="order-details.php" class="mx-4">
                                                <i class="fas fa-eye"></i>
                                                <span>Order Details</span>
                                            </a>
                                            <a href="#" class="mx-4 mt-3" data-bs-target="#modify-order" data-bs-toggle="modal">
                                                <i class="fa-solid fa-download"></i>
                                                <span>Modify Order</span>
                                            </a>
                                            <a href="#" class="mx-4 mt-3" data-bs-toggle="modal" data-bs-target="#cancel-order">
                                                <i class="fa-solid fa-download"></i>
                                                <span>Cancel Order</span>
                                            </a>
                                            <a href="#" class="mx-4 mt-3">
                                                <i class="fa-solid fa-download"></i>
                                                <span>Invoice</span>
                                            </a>
                                        </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="d-flex orders">
                                            ...
                                            <ul>
                                                ...
                                                <li><span>Order Status: </span><span class="badge bg-success"> Order delivered </span></li>
                                            </ul>
                                        </div>
                ...
                <div class="modal fade" id="cancel-order">
                    <div class="modal-dialog bg-light">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="p-3 row">
                                    <span class="badge alert-info">Order can be cancel before order gets confirmed</span>
                                    <form>

                                        <div class="col-12">
                                            <label class="form-label"> Phone Number </label> <br>
                                            <input type="text" placeholder="Phone Number" requird class="form-control">
                                        </div>

                                        <div class="mt-4">
                                            <label class="form-label"> Why you want to cancel this order? </label> <br>
                                            <textarea placeholder="write your reason here" class="form-control"> </textarea>
                                        </div>

                                        <div class="mt-4">
                                            <button type="submit" class="btn btn-primary" style="width: 100%">Cancel Now</button>
                                        </div>
                                    </form>
                ...
                <div class="modal fade" id="modify-order">
                    <div class="modal-dialog bg-light">
                        <div class="modal-content">
                                ...
                                <div class="p-3 row">
                                    ...
                                    <form class="cart-items">
                                        ...
                                        <div class="col-12 mt-3">
                                            <input type="submit" value="Update Order" name="submit" class="btn btn-primary border-0" disabled>
                                        </div>
                                    </form>
                                </div>
                            </div>
